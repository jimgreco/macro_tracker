...
Users can export a JSON copy of account data or permanently delete the account from Account & Privacy on the web or Settings on iOS. Users can disconnect Oura and delete imported Oura data from either Settings surface, revoke HealthKit access from iOS Settings, and sign out from the app.
