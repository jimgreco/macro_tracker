...
- Native Settings does not present Stripe checkout or portal links in the worldwide App Store build. Apple requires in-app purchase for digital upgrades in many storefronts; plan gating is currently disabled.
