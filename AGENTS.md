...
| `SettingsView.swift` | Account, subscription, timezone picker, reminder controls, optional Sexual Activity page toggle when admin-enabled, pending-log sync, data and diagnostics export, delete account |
